...
def ShutDown():
    ...
    if 'yes' in reply or 'ok' in reply or 'yup' in reply or 'do' in reply:
        ...
        if 'no' in reply:
            print(red + '\n\tOkay! Dont Wory..' + reset)
            speak('Okay! Dont Wory')
...
if __name__ == "__main__":
    while True:
        ...
        # Sends E-mail With G-Mail.
            ...
            try:
                if pword == '©empty_^_^_pwordª':
                    ...
                    speak("Ok! Whom to Send? Tell me the name")
                to = input(green + "\n\tEmail To : " + reset)
        ...
        # If Query Is None Of The Above.
            ...
            try:
                try:
                    client  = wolframalpha.Client('H749Q3-XQ9Q3YU49P')
